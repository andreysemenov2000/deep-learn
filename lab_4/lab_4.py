...
correct = 0
total = 0
# отключим вычисление граиентов, т.к. будем делать только прямой проход
with torch.no_grad():
...
test_one_image("animals/val/cat/flickr_cat_000011.jpg")
test_one_image("animals/val/dog/flickr_dog_000045.jpg")
test_one_image("animals/val/wild/flickr_wild_000040.jpg")
